...
@section('title', 'Update Peak Hour Surge Window - ')
...
<div class="form-glass-card">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
        <div>
            <h4>
                ...
                <span>Update Peak Hour Surge Window</span>
            </h4>
            <span class="section-sub">Modify start and end times for this scheduled emergency surge interval.</span>
        </div>
    ...
    <form action="{{ route('admin.peakhour.update', $peakhour->id) }}" method="POST" role="form">
        {{ csrf_field() }}
        ...
        <div class="row">
            <div class="col-md-6 form-group">
                ...
                <div class="input-group">
                    <input class="form-control" autocomplete="off" type="text" value="{{ date('h:i A', strtotime($peakhour->start_time)) }}" name="start_time" required id="start_time">
            ...
            <div class="col-md-6 form-group">
                ...
                <div class="input-group">
                    <input class="form-control" autocomplete="off" type="text" value="{{ date('h:i A', strtotime($peakhour->end_time)) }}" name="end_time" required id="end_time">
                    <span class="input-group-addon" style="background: var(--stat-pill-bg); border-color: var(--border-line); color: var(--cyan-bright);">
                        <i class="fa-solid fa-clock"></i>
                    </span>
                </div>
        ...
        <div style="margin-top: 28px; padding-top: 20px; border-top: 1px solid var(--border-line);">
            <button type="submit" class="btn-submit-action">
                <i class="fa-solid fa-floppy-disk"></i> Save Window Changes
            </button>
            <a href="{{ route('admin.peakhour.index') }}" class="btn-cancel-action">
                @lang('admin.cancel')
            </a>
